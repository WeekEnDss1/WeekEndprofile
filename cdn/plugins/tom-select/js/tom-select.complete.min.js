...
e=e.parentNode}},C=(e,t=0)=>t>0?e[e.length-1]:e[0],I=(e,t)=>{if(!e)return-1
t=t||e.nodeName
...
super(),this.order=0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.hasOptions=!1,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},H++
var s=g(e),n=this
...
if(v.settings.shouldLoad.call(v,f)?v.loading?C("loading"):0===m.items.length&&C("no_results"):C("not_loading"),(a=v.canCreate(f))&&(p=C("option_create")),v.hasOptions=m.items.length>0||a,b){if(m.items.length>0){if(!w.contains(O)&&"single"===v.settings.mode&&v.items.length&&(O=v.getOption(v.items[0])),!w.contains(O)){let e=0
...
function r(t,i,s){return t||(t=g('<option value="'+P(i)+'">'+P(s)+"</option>")),t.selected=!0,_(t,{selected:"true"}),z(e,t),t}if(t.input.querySelectorAll("option[selected]").forEach((e=>{_(e,{selected:null}),e.selected=!1})),0!=t.items.length||"single"!=t.settings.mode||t.isRequired)for(i=0;i<t.items.length;i++)if(s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",e.contains(n.$option)){r(t.input.querySelector(`option[value="${N(s)}"]`),s,o)}else n.$option=r(n.$option,s,o)
...
const l=[]
if(r.activeItems.length){n=C(r.activeItems,t),s=I(n),t>0&&s++
...
const o=this
return("option"===e||"item"===e)&&(n=L(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,P))||(s=g(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?_(s,{"aria-disabled":"true"}):_(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],_(s,{"data-group":i}),t.group[o.settings.disabledField]&&_(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(_(s,{"data-value":n}),"item"===e?m(s,o.settings.itemClass):(m(s,o.settings.optionClass),_(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
